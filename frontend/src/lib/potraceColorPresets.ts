...
export const POTRACE_COLOR_PRESETS: PotraceColorPreset[] = [
  ...
  },
  {
    ...
    label: "Figma Clean",
    description:
      "Minimal layers and anchor points — aggressive color merging and curve simplification, tuned for editing in Figma or Illustrator.",
    settings: {
      n_colors: 8,
      upscale_factor: 3,
      smoothing: "mean_shift",
      smooth_spatial_radius: 15,
      smooth_color_radius: 25,
      alpha_threshold: 128,
      min_region_pixels: 64,
      merge_color_distance: 16,
      mask_cleanup: true,
      turdsize: 8,
      alphamax: 1.3,
      opttolerance: 0.8,
